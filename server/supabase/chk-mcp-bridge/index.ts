...
Deno.serve(async(req:Request)=>{
 ...
 try{
  ...
  if(action==="create_cancel_proposal"){
    ...
    const replacementQuote=b?.replacementQuoteAmountUsdc==null?null:Number(b.replacementQuoteAmountUsdc);if(replacementQuote!=null&&(!(replacementQuote>0)||replacementQuote>30.0000001))return out(400,{error:"invalid_replacement_amount"});
